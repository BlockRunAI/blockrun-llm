...
(upstream commit ``18bf4ab``), the same routing engine the TypeScript SDK and
...
from .strategy import RouterStrategy, RulesStrategy, get_strategy, register_strategy
